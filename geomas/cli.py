...
@app.command()
def process_visual_docs_with_embedding(
    ...
    from pathlib import Path
    from geomas.core.vision.visual_data_processor import VisualDataProcessor
    from geomas.core.vision.embedding_processor import MultimodalEmbeddingProcessor
    ...
    try:
        ...
        embedding_processor=MultimodalEmbeddingProcessor()
        # Process documents
