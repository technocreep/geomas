...
Проверяет три основные функциональности:
1. Разбиение PDF на части (клетка 3)
2. Генерация QA пар через Gemini API (клетка 2)
3. Очистка результатов от метаданных (клетка 5)
"""
...
def test_2_qa_generation(pdf_dir: str = None):
    ...
    api_key = "AIzaSyDZ0u6rtNHB2IEtP6PbJPa9jPqoFU11C7M"  # Пропускаем тест если не указан ключ
...
╚════════════════════════════════════════════════════════════════════════════════╝
    ...
    print("✅ Все три функциональности были протестированы")
    print("\n📋 Что было проверено:")
    print("  1. ✅ Разбиение PDF на части с заданными параметрами")
    print("  2. ✅ Генерация QA пар через Gemini API с использованием промпта")
    print("  3. ✅ Очистка результатов от служебных полей")
    print("\n💡 Примечания:")
